          ...
          replacement: Container(
            ...
            child: Tooltip(
              ...
              child: IconButton(
                ...
                icon: Image.asset('assets/images/icons/${isSelected ? menu.assetIconSelected : menu.assetIcon}.png'),
              ),
            ),
          ),
          child: Material(
                ...
                child: Row(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Image.asset('assets/images/icons/${isSelected ? menu.assetIconSelected : menu.assetIcon}.png'),
                    ),
                    const SizedBox(
                      width: 10,
                    ),
