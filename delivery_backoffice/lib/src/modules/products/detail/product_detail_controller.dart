...
enum ProductDetailStateStatus { initial, loading, loaded, error, errorLoadProduct, deleted, uploaded, saved }
...
abstract class ProductDetailControllerBase with Store {
  ...
  Future<void> uploadImageProduct(Uint8List file, String fileName) async {
    ...
    _imagePath = await _productRepository.updateImageProduct(file, fileName);
